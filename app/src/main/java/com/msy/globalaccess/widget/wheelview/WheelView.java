package com.msy.globalaccess.widget.wheelview;
...
import com.msy.globalaccess.widget.dialog.ItemsRange;
import com.msy.globalaccess.widget.dialog.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    /**
     * Set wheel cyclic flag (设置轮循环标志)
     *
     * @param isCyclic the flag to set  (是否循环)
     */
