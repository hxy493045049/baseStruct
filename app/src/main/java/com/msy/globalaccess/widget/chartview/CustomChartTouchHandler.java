 ...
 */
public class CustomChartTouchHandler {
    ...
    public CustomChartTouchHandler(Context context, CustomChart chart) {
        this.chart = chart;
        this.computator = chart.getChartComputator();
        this.renderer = chart.getChartRenderer();
        gestureDetector = new GestureDetector(context, new CustomChartTouchHandler.ChartGestureListener());
        scaleGestureDetector = new ScaleGestureDetector(context, new CustomChartTouchHandler.ChartScaleGestureListener());
