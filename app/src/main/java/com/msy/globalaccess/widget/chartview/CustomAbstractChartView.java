 ...
 * @author Leszek Wach
 */
public abstract class CustomAbstractChartView extends View implements CustomChart {
    protected ChartComputator chartComputator;
    protected CustomAxesRenderer axesRenderer;
    protected CustomChartTouchHandler touchHandler;
    ...
    public CustomAbstractChartView(Context context) {
        this(context, null, 0);
    }

    public CustomAbstractChartView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomAbstractChartView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        chartComputator = new ChartComputator();
        touchHandler = new CustomChartTouchHandler(context, this);
        axesRenderer = new CustomAxesRenderer(context, this);

        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            this.dataAnimator = new CustomChartDataAnimatorV8(this);
            this.viewportAnimator = new CustomChartViewportAnimatorV8(this);
        } else {
            this.viewportAnimator = new CustomChartViewportAnimatorV14(this);
            this.dataAnimator = new CustomChartDataAnimatorV14(this);
        }
    }
    ...
    @Override
    public CustomAxesRenderer getAxesRenderer() {
        return axesRenderer;
    }
    ...
    @Override
    public CustomChartTouchHandler getTouchHandler() {
        return touchHandler;
    }
