...
@SuppressLint("NewApi")
public class CustomChartViewportAnimatorV14 implements ChartViewportAnimator, Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
    ...
    public CustomChartViewportAnimatorV14(CustomChart chart) {
        this.chart = chart;
