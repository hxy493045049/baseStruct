...
public class BadgeView extends TextView {
     ...
     * 圆的大小（半径）
     */
    private int circularSize = 5;

    /**
     * 圆的左右内边距
     */
    private int paddingLR = 3;
    ...
    private void init() {
        ...
        setPadding(dip2Px(paddingLR), dip2Px(paddingTB), dip2Px(paddingLR), dip2Px(paddingTB));

        // set default background
        setBackground(circularSize, Color.parseColor("#d3321b"));
