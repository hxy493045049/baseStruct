 ...
 */
public class CustomColumnChartRenderer extends CustomAbstractChartRender {
    ...
    public CustomColumnChartRenderer(Context context, CustomChart chart, ColumnChartDataProvider dataProvider) {
        super(context, chart);
